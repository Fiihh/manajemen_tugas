                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST" action="<?php echo e(route('loginProses')); ?>">
                                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="text-center">
                                        <small>
                                               Kembali Ke Beranda ?
                                        <a href="<?php echo e(route('welcome')); ?>">Klik Disini</a>
                                        </small>                                   
                                    </div>
                            </div>
                        </div>
    ...
    <script src="<?php echo e(asset('sweetalert2/dist/sweetalert2.all.min.js')); ?>"></script>
...
</html><?php /**PATH C:\laragon\www\manajemen_tugas\resources\views/auth/login.blade.php ENDPATH**/ ?>